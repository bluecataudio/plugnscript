...
string name="Sin Synth Poly";
string description="Simple sine wave synth (polyphonic)";

array<string> inputParametersNames={"Attack", "Release", "Pitch Attack", "Pitch Drop", "Gain"};
array<double> inputParameters(inputParametersNames.length);
array<double> inputParametersDefault={0,.5,0,1,0.5};

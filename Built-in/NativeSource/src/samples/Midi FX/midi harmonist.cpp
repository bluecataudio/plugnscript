...
// parameters
DSP_EXPORT array<string> inputParametersNames={"Key", "Note 1", "Note 2", "Note 3", "Note 4"} ;
DSP_EXPORT array<double> inputParameters(inputParametersNames.length);

DSP_EXPORT string intervals="-11th;-9th;-Oct;-7th;-6th;-5th;-4th;-3rd;-2nd;None;+2nd;+3rd;+4th;+5th;+6th;+7th;+Oct;+9th;+11th";
DSP_EXPORT array<double> inputParametersMin={0,-9,-9,-9,-9};
DSP_EXPORT array<double> inputParametersMax={11,9,9,9,9};
DSP_EXPORT array<double> inputParametersDefault={0,0,0,0,0};
DSP_EXPORT array<string>  inputParametersEnums={"C;C#;D;D#;E;F;F#;G;G#;A;A#;B",intervals,intervals,intervals,intervals};
DSP_EXPORT array<int>    inputParametersSteps={12,19,19,19,19};

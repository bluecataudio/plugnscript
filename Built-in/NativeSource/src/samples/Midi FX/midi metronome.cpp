...
DSP_EXPORT array<string> inputParametersNames={"1st Note", "Note", "1st Velocity" ,"Velocity", "Duration"};
DSP_EXPORT array<double> inputParameters(inputParametersNames.length,0);

DSP_EXPORT array<double> inputParametersMin={0,0,0,0};
DSP_EXPORT array<double> inputParametersMax={127,127,127,127};
...
DSP_EXPORT void updateInputParametersForBlock(const TransportInfo* )
{

...
DSP_EXPORT array<double> inputParametersDefault={0.01,0.5,0.5,.5,.5};
        ...
        switch(state)
        {
            ...
            case kReleasePhase:
            {
                ...
                if(currentAmplitude<.0001)
                {
                    ...
                    if(!(*this==voices[activeVoicesCount-1]))
                    {
...
DSP_EXPORT void updateInputParametersForBlock()
{
